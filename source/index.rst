...
.. _`downloadable PDF version`: http://readthedocs.org/projects/dhis2-malaria-stock-status-monitoring-tool-userguide/downloads/pdf/latest/

.. _`mobile friendly EPUB version`: http://readthedocs.org/projects/dhis2-malaria-stock-status-monitoring-tool-userguide/downloads/epub/latest/

.. _`downloadable HTML version`: http://readthedocs.org/projects/dhis2-malaria-stock-status-monitoring-tool-userguide/downloads/htmlzip/latest/
